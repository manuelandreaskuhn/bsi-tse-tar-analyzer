...
window.RulesCat14 = (function() {
  ...
  function run(ctx) {
    ...
    results.push(Utils.info('CSC_CROSS_LOG', 'Signaturzähler stimmt mit TAR-Log überein', CAT,
      'Prüfung erfordert externen Signaturzähler-Rückgabewert der TSE (API-Laufzeit). Statische TAR-Analyse: signatureCounter-Konsistenz innerhalb des Archivs bereits durch CROSS_LOG_CTR_UNIQUE abgedeckt.',
